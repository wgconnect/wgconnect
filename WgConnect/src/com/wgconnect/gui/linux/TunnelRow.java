...
public class TunnelRow extends HBox {
    ...
    public TunnelRow init() {        
        tunnelAddrsBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_TUNNEL_ADDRS);
        ...
        endpointsBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_ENDPOINTS);
        ...
        publicKeysBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_PUBLIC_KEYS);
        ...
        statusBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_STATUS);
        ...
        bandwidthsBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_BANDWIDTHS);
        ...
        markersBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_MARKERS);
        ...
        interfacesBox = new ColumnBox(this, LinuxGui.COLUMN_INDEX_INTERFACES);
    ...
    public void refreshColumns(int... columnIndices) {
        ...
        for (int columnIndex : columnIndices) {
            if (columnIndex < getChildren().size()) {
                ...
                switch (columnIndex) {
                    case LinuxGui.COLUMN_INDEX_TUNNEL_ADDRS:
                    ...
                    case LinuxGui.COLUMN_INDEX_ENDPOINTS:
                    ...
                    case LinuxGui.COLUMN_INDEX_PUBLIC_KEYS:
                    ...
                    case LinuxGui.COLUMN_INDEX_STATUS:
                    ...
                    case LinuxGui.COLUMN_INDEX_BANDWIDTHS:
                    ...
                    case LinuxGui.COLUMN_INDEX_MARKERS:
