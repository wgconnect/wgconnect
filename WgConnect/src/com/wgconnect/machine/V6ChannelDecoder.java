 ...
 * V6ChannelDecoder
 * 
 * The protocol decoder used when receiving V6 packets.
 * 
 * @author JagornetDhcp version: A. Gregory Rabil
 * @author WgConnect version: wgconnect@proton.me
 */
@ChannelHandler.Sharable
public class V6ChannelDecoder extends OneToOneDecoder {

    private static final WgConnectLogger log = WgConnectLogger.getLogger(V6ChannelDecoder.class);
    ...
    public V6ChannelDecoder(InetSocketAddress localSocketAddress, boolean ignoreSelfPackets) {
        this.localSocketAddress = localSocketAddress;
        this.ignoreSelfPackets = ignoreSelfPackets;
    }

    /*
     * Decodes a received ChannelBuffer into a V6Message.
     * (non-Javadoc)
     * @see org.jboss.netty.handler.codec.oneone.OneToOneDecoder#decode
    ...
    protected Object decode(ChannelHandlerContext ctx, Channel channel, Object msg) throws Exception {
        if (msg instanceof ChannelBuffer) {
            ...
            V6Message dhcpMessage = V6Message.decode(buf.toByteBuffer(), localSocketAddress, remoteSocketAddress);
            return dhcpMessage;
        } else {
    ...
    /* (non-Javadoc)
     * @see org.jboss.netty.handler.codec.oneone.OneToOneDecoder#handleUpstream
