...
----
$ cd <WgConnect NetBeans project directory>
$ jpackage --verbose --type app-image --input ./dist/ --dest . --name WgConnect --main-jar ./dist/WgConnectAll.jar --main-class com.wgconnect.WgConnect --java-options -Xmx2048m
$ makeself.sh --notemp --bzip2 ./wgconnect ./wgconnect.bz2.sh "WgConnect package"
----

This will create an executable installation file called *wgconnect.bz2.sh*.
